...
(function installCsrfFetch() {
    ...
    window.fetch = function (input, init = {}) {
        ...
        // Balance AI, which waits on a local model for ten or twenty seconds and
        // shows that in its own panel — blurring out the figures being asked
        // about is the one thing that must not happen while it thinks).
